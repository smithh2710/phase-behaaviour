function [GOC_depth, GOC_type, GOC_pressure, GOC_comp, info] = detect_GOC(comp_ref, press_ref, temp_ref, h_ref, depth_range, Pc, Tc, acentric, BIP, M_gmol, vt_type, vt_params)
