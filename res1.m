...
depth_range = [0, 350];
 % [comp_h, press_h, pressbub_h, pressdew_h] = main(102.5, 175, comp, 284e5, temp, Pc, Tc, acentric, BIP, M_gmol, 1)
 [GOC_depth, GOC_type, GOC_pressure, GOC_comp, convergence_info] = detect_GOC(comp, press_ref, temp, h_ref, depth_range, Pc, Tc, acentric, BIP, M_gmol, 1, vt_params)
